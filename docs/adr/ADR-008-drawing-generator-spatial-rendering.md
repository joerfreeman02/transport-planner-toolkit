...
Scale/extent are testable and raster pixels do not determine geometry. The static module remains deployable on GitHub Pages without a service dependency. Raster basemap context, advanced label placement and authoritative hosted-data services are deferred. Proj4 precision, browser print settings and public-provider availability remain documented constraints. This ADR is Proposed pending Product Owner review and does not establish a cross-tool shared spatial package.
