...
Alpha.14 corrects the Alpha.13 manual-acceptance failure where production-shaped route variants were promoted to extra planner rows. Compatible source evidence now consolidates by route, principal direction and genuine corridor; circular/linear classification, alternate termini, source pattern/StopPoint variants, operator aliases and calendar profiles remain within the row where the evidence supports the same service family. Explicitly distinct corridors remain separate. The representative-stop rule, canonical physical-journey deduplication, calendar-safe frequency, raw provenance and Browser/Word parity are retained. The production-representative audit controls 25C, 66, 242, 310, 46, 230, 231, 357, 444, W16 and 657.
