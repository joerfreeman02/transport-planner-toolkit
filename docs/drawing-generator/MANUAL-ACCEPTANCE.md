...
2. Confirm the banner says `WORK IN PROGRESS / LIVE REVIEW - NOT ACCEPTED BASELINE` and the build says `DRAW-0.1.0-DG0C3.2-20260817`.
...
10. Select **Local Context**, retrieve local candidates, include only relevant community considerations, and draw/import any missing bus/cycle/rail groups.
