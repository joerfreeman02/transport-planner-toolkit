export const DRAWING_MODES = Object.freeze({
  ...
  'local-context': Object.freeze({
    ...
    visibleClasses: Object.freeze(['site', 'cycle-network-primary', 'cycle-network-local', 'cycle-route', 'railway', 'station-overground', 'bus-route', 'community', 'custom-line', 'custom-point', 'custom-area'])
  }),
