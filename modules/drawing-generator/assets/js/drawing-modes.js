export const DRAWING_MODES = Object.freeze({
  'regional-plan': Object.freeze({
    ...
    requiredClasses: Object.freeze(['site', 'main-road', 'motorway', 'strategic-cycle', 'waterway', 'railway', 'rail-station']),
    visibleClasses: Object.freeze(['site', 'main-road', 'motorway', 'strategic-cycle', 'waterway', 'railway', 'station-national-rail', 'station-overground', 'station-underground', 'station-dlr', 'station-tram', 'custom-line', 'custom-point', 'custom-area'])
  }),
  'regional-routing': Object.freeze({
    ...
    visibleClasses: Object.freeze(['site', 'main-road', 'motorway', 'strategic-cycle', 'waterway', 'railway', 'station-national-rail', 'station-overground', 'station-underground', 'station-dlr', 'station-tram', 'route-to-site', 'route-from-site', 'custom-line', 'custom-point', 'custom-area'])
  }),
  'local-context': Object.freeze({
    ...
    visibleClasses: Object.freeze(['site', 'main-road', 'cycle-route', 'railway', 'station-national-rail', 'station-overground', 'station-underground', 'station-dlr', 'station-tram', 'bus-route', 'community', 'custom-line', 'custom-point', 'custom-area'])
  }),
  'local-routing': Object.freeze({
    ...
    visibleClasses: Object.freeze(['site', 'railway', 'station-national-rail', 'station-overground', 'station-underground', 'station-dlr', 'station-tram', 'community', 'route-to-site', 'route-from-site', 'custom-line', 'custom-point', 'custom-area'])
  })
});
