...
try {
  for (const mode of modes) {
    ...
    await page.pdf({ path: path.join(output, `drawing-generator-${mode}-DG0C3.3B-HF4A-live-review.pdf`), format: 'A3', landscape: true, printBackground: true, preferCSSPageSize: true, margin: { top: '0', right: '0', bottom: '0', left: '0' } });
    await page.close();
  }
