...
const pdfPath = path.join(output, 'drawing-generator-regional-plan-DG0C3-real-world-Milton-Keynes-QA.pdf');
...
try {
  ...
  await page.evaluate(() => window.__DG0_ACCEPTANCE__.setLocation(52.0406, -0.7594, 'Milton Keynes, UK'));
  await page.locator('#advancedTools > summary').click();
  const metadata = {
    client: 'EAS INTERNAL QA',
    architect: 'N/A',
    project: 'MILTON KEYNES LIVE OSM QA',
    projectNumber: 'DG0C3-LIVE-QA',
    designedBy: 'QA',
    drawnBy: 'QA',
    revision: 'C3',
    revisionDescription: 'Real-world OpenStreetMap visual QA',
