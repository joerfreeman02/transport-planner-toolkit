...
const pdfPath = path.join(output, 'drawing-generator-regional-routing-DG0C3.1-real-world-Milton-Keynes-QA.pdf');
...
try {
  ...
  const metadata = {
    client: 'EAS INTERNAL QA', project: 'MILTON KEYNES LIVE ROUTING QA', projectNumber: 'DG0C3.1-ROUTE-QA',
    designedBy: 'QA', drawnBy: 'QA', revision: 'C3.1', revisionDescription: 'Real OSM and road-snapped route QA', drawingStatus: 'WORK IN PROGRESS'
  };
