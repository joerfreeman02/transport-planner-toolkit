...
The normal assessment presents directional frequencies as readable rows. Research exchange files remain structured JSON for reliable machine validation, but are confined to the Research & Library workflow.
