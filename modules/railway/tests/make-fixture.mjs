...
const out=buildResearchRequest(stations,'RAIL-4.0.0-20260714');out.fixture=true;out.fixtureNotice='Test fixture only. Do not import into a production knowledge library.';
