...
export function buildControlledBusWording(serviceSummaries, { nearestGroupName = null } = {}) {
  ...
  return `${nearestLead}The assessed stop${nearestGroupName ? ' group is' : 's are'} served by ${routeWords}${locations.length ? `, providing direct connections along the represented service patterns to ${locations.join(', ')}` : ''}. Timetable periods and any material qualifications are shown in the Bus Service Summary.`;
}
