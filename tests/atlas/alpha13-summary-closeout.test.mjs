...
assert.match(route25C.at(-1).routeGroupNote ?? '', /Additional short workings and timetable variants operate/);
...
assert.match(route242.at(-1).routeGroupNote ?? '', /Additional short workings and timetable variants operate/);
