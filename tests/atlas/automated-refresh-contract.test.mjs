...
assert.match(workflow, /candidate-checkpoint\.mjs --rebase/);
...
assert.ok(workflow.indexOf('Validate fresh or restored candidate data') < workflow.indexOf('Rebase verified checkpoint for current run'));
