...
assert.equal(reviewWordRows.some(row => !Array.isArray(row) && /Evidence items to review|Review this timetable evidence/.test(row.text)), false, 'Word keeps raw review diagnostics out of the document');
