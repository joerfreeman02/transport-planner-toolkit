...
assert.match(html, /2\.0\.0-alpha\.8/);
assert.match(html, /ATLAS-2\.0\.0-alpha\.8-20260908/);
...
console.log('PASS Bus UI contract - Alpha.8 status, selection and local maintenance controls are exposed without browser credentials.');
