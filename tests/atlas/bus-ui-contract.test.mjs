...
assert.match(html, /2\.0\.0-alpha\.14/);
assert.match(html, /ATLAS-2\.0\.0-alpha\.14-20260913/);
...
console.log('PASS Bus UI contract - Alpha.14 planner summary, task status, selection, full-week frequency, radius map and local maintenance controls are exposed without browser credentials.');
