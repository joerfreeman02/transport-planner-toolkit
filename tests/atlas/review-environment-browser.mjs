...
try {
  ...
  assert.equal(await page.getByRole('heading', { name: 'Check nearby bus stops', exact: true }).isVisible(), true);
  ...
  const requiredAssets = ['/atlas/', '/atlas/assets/css/atlas-shell.css', '/atlas/assets/js/app.mjs', '/src/atlas/domain/site.mjs'];
