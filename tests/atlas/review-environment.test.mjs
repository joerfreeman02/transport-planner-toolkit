...
try {
  ...
  assert.equal(JSON.parse(await readFile(stateFile, 'utf8')).version, '2.0.0-alpha.11');
  ...
  assert.match(atlasHtml, /2\.0\.0-alpha\.11/);
  assert.match(atlasHtml, /ATLAS-2\.0\.0-alpha\.11-20260909/);
