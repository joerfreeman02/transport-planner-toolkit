...
for (const marker of ['Bus Assessment', 'Find nearby stops', 'Search radius', 'Walking', 'Cycling', 'BUS-1.7.0', 'Bus Route and Service Review']) {
...
for (const [label,actual,expected] of [['Dashboard',manifest.modules.dashboard.version,'1.4.0'],['Accessibility',manifest.modules.accessibility.version,'1.5.0'],['Railway',manifest.modules.railway.version,'4.10.0'],['Bus',manifest.modules.bus.version,'1.7.0'],['Library Manager',manifest.modules.libraryManager.version,'1.2.0'],['STATS19',manifest.modules.stats19.version,'1.0.0']]) {
